...
export default {
  ...
  enableUnjoinCharacters () {
    let observer = atom.workspace.observeTextEditors((editor) => {
      ...
      let observer = editor.onDidChange(unjoin)
      this.unjoinObservers.push(observer) // TODO this looks very suspicious
    })
  ...
  enableHighlightHiddenCharacters () {
    let observer = atom.workspace.observeTextEditors((editor) => {
      ...
      this.hiddenCharObservers.push(observer) // TODO this looks very suspicious
    })
